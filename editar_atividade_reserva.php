...
list($status, $cor) = calcularStatusCor($atividade['data_tarefa'], $atividade['data_fim']);
?>
...
<form method="post">
    ...
    <div class="mb-3">
        <label for="data_tarefa" class="form-label">Data da Tarefa</label>
        <input type="date" class="form-control" name="data_tarefa" id="data_tarefa"
               value="<?= $atividade['data_tarefa'] ?>">
        <small class="form-text text-muted">Usada para calcular se está em andamento ou parada.</small>
    </div>
